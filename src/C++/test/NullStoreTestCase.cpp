...
TEST_FIXTURE( sharedObjectFixture, other )
{
  ...
  CHECK( object.getNextSenderMsgSeqNum() == 10 );
  object.setNextTargetMsgSeqNum( 20 );
  CHECK( object.getNextTargetMsgSeqNum() == 20 );
  object.incrNextSenderMsgSeqNum();
  CHECK( object.getNextSenderMsgSeqNum() == 11 );
  object.incrNextTargetMsgSeqNum();
  CHECK( object.getNextTargetMsgSeqNum() == 21 );
...
TEST_FIXTURE( sharedObjectFixture, reload )
{
  ...
  CHECK( object.getNextSenderMsgSeqNum() == 5 );
  CHECK( object.getNextTargetMsgSeqNum() == 6 );
}
